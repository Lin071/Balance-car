...
void Oled_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);	 //使能PTA端口时钟

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7;	 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		 //速度50MHz
 	GPIO_Init(GPIOA, &GPIO_InitStructure);	  				 //初始化PTB10、PTB11
	...
	OLED_ShowString(2,8,(u8 *)"^Hello!^",16);		//OLED屏幕显示 Hello
} 
